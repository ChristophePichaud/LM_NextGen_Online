...
#define FS_REG_BASE     "SOFTWARE\\Lockheed Martin\\Prepar3D v6"
...
#define HELPID_CESS_FUEL_SHUTOFF                (HELPID_CESS + 0x003F)
...
//  Tooltips (0x0E00-0x0F00)
#define HELPID_TOOLTIP                                   (HELPID_MIN +  0x0E00)
#define HELPID_GAUGE_FLAPS_SWITCH_WITH_DESCRIPTION       (HELPID_TOOLTIP + 0x000F)
#define HELPID_GAUGE_HEADING_BUG_ADJUST_WITH_DESCRIPTION (HELPID_TOOLTIP + 0x0027)
#define HELPID_GAUGE_HEADING_INDICATOR_WITH_DESCRIPTION  (HELPID_TOOLTIP + 0x0028)
...
#define TOOLTIPTEXT_CHT_FAHRENHEIT                  (TOOLTIPTEXT_BASE + 0x00D8)
#define TOOLTIPTEXT_ENG1_CHT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00D9)
#define TOOLTIPTEXT_ENG2_CHT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00DA)
#define TOOLTIPTEXT_ENG3_CHT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00DB)
#define TOOLTIPTEXT_ENG4_CHT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00DC)
...
#define TOOLTIPTEXT_EGT_FAHRENHEIT                  (TOOLTIPTEXT_BASE + 0x00E8)
#define TOOLTIPTEXT_ENG1_EGT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00E9)
#define TOOLTIPTEXT_ENG2_EGT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00EA)
#define TOOLTIPTEXT_ENG3_EGT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00EB)
#define TOOLTIPTEXT_ENG4_EGT_FAHRENHEIT             (TOOLTIPTEXT_BASE + 0x00EC)
...
#define TOOLTIPTEXT_OIL_TEMPERATURE_FAHRENHEIT      (TOOLTIPTEXT_BASE + 0x00F8)
#define TOOLTIPTEXT_ENG1_OIL_TEMPERATURE_FAHRENHEIT (TOOLTIPTEXT_BASE + 0x00F9)
#define TOOLTIPTEXT_ENG2_OIL_TEMPERATURE_FAHRENHEIT (TOOLTIPTEXT_BASE + 0x00FA)
#define TOOLTIPTEXT_ENG3_OIL_TEMPERATURE_FAHRENHEIT (TOOLTIPTEXT_BASE + 0x00FB)
#define TOOLTIPTEXT_ENG4_OIL_TEMPERATURE_FAHRENHEIT (TOOLTIPTEXT_BASE + 0x00FC)
...
#define TOOLTIPTEXT_AMBIENT_TEMPERATURE_FAHRENHEIT  (TOOLTIPTEXT_BASE + 0x0225)
...
#define TOOLTIPTEXT_RADIATOR_TEMPERATURE_FAHRENHEIT (TOOLTIPTEXT_BASE + 0x0271)
...
#define TOOLTIPTEXT_P51_VOLT_AMMETER                (TOOLTIPTEXT_BASE + 0x04FC)
#define TOOLTIPTEXT_TEST_BUTTON		                (TOOLTIPTEXT_BASE + 0x04FD)
#define TOOLTIPTEXT_SWITCH_COVER	                (TOOLTIPTEXT_BASE + 0x04FE)
#define TOOLTIPTEXT_ANTIDETONATION_FLUID_SWITCH     (TOOLTIPTEXT_BASE + 0x04FF)
#define	TOOLTIPTEXT_RAISE_HOIST						(TOOLTIPTEXT_BASE + 0x0500)
#define TOOLTIPTEXT_LOWER_HOIST						(TOOLTIPTEXT_BASE + 0x0501)
#define	TOOLTIPTEXT_ATTITUDE_CALIBRATION_KNOB		(TOOLTIPTEXT_BASE + 0x0502)
#define TOOLTIPTEXT_ENG_PRIMER_SWITCH               (TOOLTIPTEXT_BASE + 0x0503)
#define TOOLTIPTEXT_FUEL_DUMP_MASTER_SWITCH         (TOOLTIPTEXT_BASE + 0x0504)

//
// Redefined tooltips to correct typos
//
#define TOOLTIPTEXT_CHT_FARENHEIT                   TOOLTIPTEXT_CHT_FAHRENHEIT
#define TOOLTIPTEXT_ENG1_CHT_FARENHEIT              TOOLTIPTEXT_ENG1_CHT_FAHRENHEIT
#define TOOLTIPTEXT_ENG2_CHT_FARENHEIT              TOOLTIPTEXT_ENG2_CHT_FAHRENHEIT
#define TOOLTIPTEXT_ENG3_CHT_FARENHEIT              TOOLTIPTEXT_ENG3_CHT_FAHRENHEIT
#define TOOLTIPTEXT_ENG4_CHT_FARENHEIT              TOOLTIPTEXT_ENG4_CHT_FAHRENHEIT
#define TOOLTIPTEXT_EGT_FARENHEIT                   TOOLTIPTEXT_EGT_FAHRENHEIT
#define TOOLTIPTEXT_ENG1_EGT_FARENHEIT              TOOLTIPTEXT_ENG1_EGT_FAHRENHEIT
#define TOOLTIPTEXT_ENG2_EGT_FARENHEIT              TOOLTIPTEXT_ENG2_EGT_FAHRENHEIT
#define TOOLTIPTEXT_ENG3_EGT_FARENHEIT              TOOLTIPTEXT_ENG3_EGT_FAHRENHEIT
#define TOOLTIPTEXT_ENG4_EGT_FARENHEIT              TOOLTIPTEXT_ENG4_EGT_FAHRENHEIT
#define TOOLTIPTEXT_OIL_TEMPERATURE_FARENHEIT       TOOLTIPTEXT_OIL_TEMPERATURE_FAHRENHEIT
#define TOOLTIPTEXT_ENG1_OIL_TEMPERATURE_FARENHEIT  TOOLTIPTEXT_ENG1_OIL_TEMPERATURE_FAHRENHEIT
#define TOOLTIPTEXT_ENG2_OIL_TEMPERATURE_FARENHEIT  TOOLTIPTEXT_ENG2_OIL_TEMPERATURE_FAHRENHEIT
#define TOOLTIPTEXT_ENG3_OIL_TEMPERATURE_FARENHEIT  TOOLTIPTEXT_ENG3_OIL_TEMPERATURE_FAHRENHEIT
#define TOOLTIPTEXT_ENG4_OIL_TEMPERATURE_FARENHEIT  TOOLTIPTEXT_ENG4_OIL_TEMPERATURE_FAHRENHEIT
#define TOOLTIPTEXT_AMBIENT_TEMPERATURE_FARENHEIT   TOOLTIPTEXT_AMBIENT_TEMPERATURE_FAHRENHEIT
#define TOOLTIPTEXT_RADIATOR_TEMPERATURE_FARENHEIT  TOOLTIPTEXT_RADIATOR_TEMPERATURE_FAHRENHEIT
...
#define KEY_TOGGLE_BRAKE_LIGHTS         (KEY_ID_MIN + 709)
#define KEY_TOGGLE_HEADLIGHT_LIGHTS     (KEY_ID_MIN + 710)
#define KEY_TOGGLE_GENERAL_LIGHTS       (KEY_ID_MIN + 711)
...
#define KEY_VIDEO_RECORD_TOGGLE             (KEY_ID_MIN + 1186)  // deprecated
...
#define KEY_MULTIPLAYER_DIRECT_VOICE_CAPTURE_START  (KEY_ID_MIN + 1191)
#define KEY_MULTIPLAYER_DIRECT_VOICE_CAPTURE_STOP   (KEY_ID_MIN + 1192)
...
#define KEY_CAPTURE_VIDEO                   (KEY_ID_MIN + 1208)
...
#define KEY_FREEZE_LATITUDE_LONGITUDE_TOGGLE    (KEY_ID_MIN + 1293) // Spelling correction for KEY_FREEZE_LATITUDE_LONGITUE_TOGGLE
#define KEY_FREEZE_LATITUDE_LONGITUDE_SET       (KEY_ID_MIN + 1294) // Spelling correction for KEY_FREEZE_LATITUDE_LONGITUE_SET
...
#define KEY_PRESSURIZATION_PRESSURE_DUMP_SWITCH_SET (KEY_ID_MIN + 1306)
#define KEY_PRESSURIZATION_RAM_SWITCH               (KEY_ID_MIN + 1307)
#define KEY_PRESSURIZATION_RAM_SWITCH_SET           (KEY_ID_MIN + 1308)
...
#define KEY_TOGGLE_TIME_PREVIEW_WINDOW          (KEY_ID_MIN + 1348)
#define KEY_TOGGLE_PLAYBACK_CONTROLS_WINDOW     (KEY_ID_MIN + 1349)

#define KEY_BLEED_AIR_SOURCE_CONTROL_SET        (KEY_ID_MIN + 1350)
#define KEY_FUEL_DUMP_SWITCH_SET                (KEY_ID_MIN + 1351)

#define KEY_EYEPOINT_LOOK_LATERAL               (KEY_ID_MIN + 1452)
#define KEY_EYEPOINT_LOOK_VERTICAL              (KEY_ID_MIN + 1453)
#define KEY_EYEPOINT_LOOK_LONGITUDINAL          (KEY_ID_MIN + 1454)
#define KEY_EYEPOINT_MOVE_LATERAL               (KEY_ID_MIN + 1455)
#define KEY_EYEPOINT_MOVE_VERTICAL              (KEY_ID_MIN + 1456)
#define KEY_EYEPOINT_MOVE_LONGITUDINAL          (KEY_ID_MIN + 1457)
#define KEY_AXIS_ZOOM                           (KEY_ID_MIN + 1458)
#define KEY_SMOOTH_EYEPOINT_RESET               (KEY_ID_MIN + 1459)
#define KEY_SMOOTH_VIEW_ORIENTATION_RESET       (KEY_ID_MIN + 1460)
#define KEY_TOGGLE_NAVIGATION_VISUALS_WINDOW    (KEY_ID_MIN + 1461)
#define KEY_OPEN_GENERAL_WINDOW                 (KEY_ID_MIN + 1462)
#define KEY_OPEN_GRAPHICS_WINDOW                (KEY_ID_MIN + 1463)
#define KEY_OPEN_CONTROL_WINDOW                 (KEY_ID_MIN + 1464)
#define KEY_OPEN_SOUND_WINDOW                   (KEY_ID_MIN + 1465)
#define KEY_OPEN_REALISM_WINDOW                 (KEY_ID_MIN + 1466)

#define KEY_CINEMATOGRAPHER_TOGGLE              (KEY_ID_MIN + 1500)

#define KEY_TOGGLE_AIRCRAFT_ELEVATOR             (KEY_ID_MIN + 1523)
#define KEY_MOUSE_CAMERA_TRANSLATE_TOGGLE        (KEY_ID_MIN + 1524)
#define KEY_CAMERA_BIAS_CAPTURE                  (KEY_ID_MIN + 1525)
#define KEY_AXIS_DRAG_PAN_PITCH                  (KEY_ID_MIN + 1526)
#define KEY_AXIS_DRAG_PAN_HEADING                (KEY_ID_MIN + 1527)
#define KEY_AXIS_DRAG_PAN_RESET                  (KEY_ID_MIN + 1528)

#define KEY_AXIS_ADJUST_PITCH                    (KEY_ID_MIN + 1529)
#define KEY_AXIS_ADJUST_HEADING                  (KEY_ID_MIN + 1530)
#define KEY_AXIS_ADJUST_TILT                     (KEY_ID_MIN + 1531)
#define KEY_MOUSE_DRAG_PAN_TOGGLE                (KEY_ID_MIN + 1532)
#define KEY_MOUSE_EDGE_PAN_TOGGLE                (KEY_ID_MIN + 1533)
#define KEY_MOUSE_DELTA_PAN_TOGGLE               (KEY_ID_MIN + 1534)

#define KEY_ZOOM_IN_MOUSE                        (KEY_ID_MIN + 1551)
#define KEY_ZOOM_OUT_MOUSE                       (KEY_ID_MIN + 1552)

#define KEY_CAMERA_RELATIVE_EYEPOINT_UP          (KEY_ID_MIN + 1553)
#define KEY_CAMERA_RELATIVE_EYEPOINT_DOWN        (KEY_ID_MIN + 1554)
#define KEY_CAMERA_RELATIVE_EYEPOINT_RIGHT       (KEY_ID_MIN + 1555)
#define KEY_CAMERA_RELATIVE_EYEPOINT_LEFT        (KEY_ID_MIN + 1556)
#define KEY_CAMERA_RELATIVE_EYEPOINT_FORWARD     (KEY_ID_MIN + 1557)
#define KEY_CAMERA_RELATIVE_EYEPOINT_BACK        (KEY_ID_MIN + 1558)
#define KEY_CAMERA_RELATIVE_EYEPOINT_RESET       (KEY_ID_MIN + 1559)

#define KEY_OBSERVER_MOVE_UP                     (KEY_ID_MIN + 1560)
#define KEY_OBSERVER_MOVE_DOWN                   (KEY_ID_MIN + 1561)
#define KEY_OBSERVER_MOVE_LEFT                   (KEY_ID_MIN + 1562)
#define KEY_OBSERVER_MOVE_RIGHT                  (KEY_ID_MIN + 1563)
#define KEY_OBSERVER_MOVE_FORWARD                (KEY_ID_MIN + 1564)
#define KEY_OBSERVER_MOVE_BACK                   (KEY_ID_MIN + 1565)

#define KEY_OBSERVER_RESET                       (KEY_ID_MIN + 1566)

#define KEY_OBSERVER_ZOOM_OUT                    (KEY_ID_MIN + 1567)
#define KEY_OBSERVER_ZOOM_IN                     (KEY_ID_MIN + 1568)

#define KEY_OBSERVER_YAW_LEFT                    (KEY_ID_MIN + 1569)
#define KEY_OBSERVER_YAW_RIGHT                   (KEY_ID_MIN + 1570)
#define KEY_OBSERVER_PITCH_UP                    (KEY_ID_MIN + 1571)
#define KEY_OBSERVER_PITCH_DOWN                  (KEY_ID_MIN + 1572)
#define KEY_OBSERVER_ROLL_LEFT                   (KEY_ID_MIN + 1573)
#define KEY_OBSERVER_ROLL_RIGHT                  (KEY_ID_MIN + 1574)

#define KEY_OBSERVER_ROTATION_TOGGLE             (KEY_ID_MIN + 1575)

#define KEY_AXIS_OBSERVER_PITCH                  (KEY_ID_MIN + 1576)
#define KEY_AXIS_OBSERVER_ROLL                   (KEY_ID_MIN + 1577)
#define KEY_AXIS_OBSERVER_YAW                    (KEY_ID_MIN + 1578)

#define KEY_OBSERVER_TOGGLE_MOUSE_LOOK           (KEY_ID_MIN + 1579)

#define KEY_OBSERVER_WORLD_MOVE_UP               (KEY_ID_MIN + 1580)
#define KEY_OBSERVER_WORLD_MOVE_DOWN             (KEY_ID_MIN + 1581)
#define KEY_OBSERVER_WORLD_MOVE_LEFT             (KEY_ID_MIN + 1582)
#define KEY_OBSERVER_WORLD_MOVE_RIGHT            (KEY_ID_MIN + 1583)
#define KEY_OBSERVER_WORLD_MOVE_FORWARD          (KEY_ID_MIN + 1584)
#define KEY_OBSERVER_WORLD_MOVE_BACK             (KEY_ID_MIN + 1585)

#define KEY_SIMCONNECT_MENU_1                    (KEY_ID_MIN + 1600)
#define KEY_SIMCONNECT_MENU_2                    (KEY_ID_MIN + 1601)
#define KEY_SIMCONNECT_MENU_3                    (KEY_ID_MIN + 1602)
#define KEY_SIMCONNECT_MENU_4                    (KEY_ID_MIN + 1603)
#define KEY_SIMCONNECT_MENU_5                    (KEY_ID_MIN + 1604)
#define KEY_SIMCONNECT_MENU_6                    (KEY_ID_MIN + 1605)
#define KEY_SIMCONNECT_MENU_7                    (KEY_ID_MIN + 1606)
#define KEY_SIMCONNECT_MENU_8                    (KEY_ID_MIN + 1607)
#define KEY_SIMCONNECT_MENU_9                    (KEY_ID_MIN + 1608)
#define KEY_SIMCONNECT_MENU_0                    (KEY_ID_MIN + 1609)

#define KEY_MISSION_MENU_1                       (KEY_ID_MIN + 1610)
#define KEY_MISSION_MENU_2                       (KEY_ID_MIN + 1611)
#define KEY_MISSION_MENU_3                       (KEY_ID_MIN + 1612)
#define KEY_MISSION_MENU_4                       (KEY_ID_MIN + 1613)
#define KEY_MISSION_MENU_5                       (KEY_ID_MIN + 1614)
#define KEY_MISSION_MENU_6                       (KEY_ID_MIN + 1615)
#define KEY_MISSION_MENU_7                       (KEY_ID_MIN + 1616)
#define KEY_MISSION_MENU_8                       (KEY_ID_MIN + 1617)
#define KEY_MISSION_MENU_9                       (KEY_ID_MIN + 1618)
#define KEY_MISSION_MENU_0                       (KEY_ID_MIN + 1619)

#define KEY_VIEW_CAMERA_TOP_DOWN                 (KEY_ID_MIN + 1620)

#define KEY_WEAPON_SYSTEM_TOGGLE                 (KEY_ID_MIN + 1621)
#define KEY_WEAPON_SYSTEM_ARMED_TOGGLE           (KEY_ID_MIN + 1622)
#define KEY_WEAPON_SYSTEM_SAFETY_TOGGLE          (KEY_ID_MIN + 1623)
#define KEY_WEAPON_STATION_NEXT                  (KEY_ID_MIN + 1624)
#define KEY_WEAPON_STATION_PREV                  (KEY_ID_MIN + 1625)
#define KEY_WEAPON_STATION_TOGGLE                (KEY_ID_MIN + 1626)
#define KEY_WEAPON_NEXT                          (KEY_ID_MIN + 1632)
#define KEY_WEAPON_PREV                          (KEY_ID_MIN + 1633)
#define KEY_WEAPON_RESET                         (KEY_ID_MIN + 1634)
#define KEY_WEAPON_SYSTEM_FIRE_DOWN              (KEY_ID_MIN + 1635)
#define KEY_WEAPON_SYSTEM_FIRE_UP                (KEY_ID_MIN + 1636)
#define KEY_WEAPON_SYSTEM_JETTISON               (KEY_ID_MIN + 1637)
#define KEY_WEAPON_SYSTEM_AXIS_FIRE              (KEY_ID_MIN + 1638)

#define KEY_FCS_POPULATE_WITH_CLOSEST_OBJECTS    (KEY_ID_MIN + 1639)
#define KEY_FCS_NEXT_TARGET                      (KEY_ID_MIN + 1640)
#define KEY_FCS_PREVIOUS_TARGET                  (KEY_ID_MIN + 1641)
#define KEY_FCS_ADD_TARGET                       (KEY_ID_MIN + 1642)
#define KEY_FCS_REMOVE_TARGET                    (KEY_ID_MIN + 1643)
#define KEY_FCS_SELECT_TARGET                    (KEY_ID_MIN + 1644)

#define KEY_COUNTERMEASURE_SYSTEM_RESET          (KEY_ID_MIN + 1645)
#define KEY_COUNTERMEASURE_SYSTEM_TOGGLE         (KEY_ID_MIN + 1646)
#define KEY_COUNTERMEASURE_SYSTEM_ARMED_TOGGLE   (KEY_ID_MIN + 1647)
#define KEY_COUNTERMEASURE_SYSTEM_STATION_TOGGLE (KEY_ID_MIN + 1648)
#define KEY_COUNTERMEASURE_SYSTEM_STATION_PREV   (KEY_ID_MIN + 1649)
#define KEY_COUNTERMEASURE_SYSTEM_STATION_NEXT   (KEY_ID_MIN + 1650)
#define KEY_COUNTERMEASURE_SYSTEM_PREV           (KEY_ID_MIN + 1651)
#define KEY_COUNTERMEASURE_SYSTEM_NEXT           (KEY_ID_MIN + 1652)
#define KEY_COUNTERMEASURE_SYSTEM_FIRE_DOWN      (KEY_ID_MIN + 1653)
#define KEY_COUNTERMEASURE_SYSTEM_FIRE_UP        (KEY_ID_MIN + 1654)

#define KEY_AXIS_BUOYANCY_SET                    (KEY_ID_MIN + 1655)
#define KEY_BUOYANCY_SET                         (KEY_ID_MIN + 1656)
#define KEY_BUOYANCY_INC                         (KEY_ID_MIN + 1657)
#define KEY_BUOYANCY_DEC                         (KEY_ID_MIN + 1658)
#define KEY_BUOYANCY_CENTER                      (KEY_ID_MIN + 1659)
#define KEY_BUOYANCY_MAX                         (KEY_ID_MIN + 1660)
#define KEY_BUOYANCY_MIN                         (KEY_ID_MIN + 1661)

// GunSystem
#define KEY_GUN_SYSTEM_TOGGLE                    (KEY_ID_MIN + 1662)
#define KEY_GUN_SYSTEM_ROTATE_GUNS               (KEY_ID_MIN + 1663) //Requires a joystick POV Hat
#define KEY_GUN_SYSTEM_AXIS_ROTATE_GUNS_X        (KEY_ID_MIN + 1664) //Requires a joystick Controller Axis-X axis
#define KEY_GUN_SYSTEM_AXIS_ROTATE_GUNS_Y        (KEY_ID_MIN + 1665) //Requires a joystick Controller Axis-Y axis
#define KEY_GUN_SYSTEM_TOGGLE_AUTOMATIC_GUNS     (KEY_ID_MIN + 1666)
#define KEY_GUN_SYSTEM_STATION_TOGGLE            (KEY_ID_MIN + 1667)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_LEFT          (KEY_ID_MIN + 1668)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_RIGHT         (KEY_ID_MIN + 1669)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_UP            (KEY_ID_MIN + 1670)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_DOWN          (KEY_ID_MIN + 1671)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_LEFT_UP       (KEY_ID_MIN + 1672)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_LEFT_DOWN     (KEY_ID_MIN + 1673)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_RIGHT_UP      (KEY_ID_MIN + 1674)
#define KEY_GUN_SYSTEM_ROTATE_GUNS_RIGHT_DOWN    (KEY_ID_MIN + 1675)
#define KEY_GUN_SYSTEM_FIRE_DOWN                 (KEY_ID_MIN + 1676)
#define KEY_GUN_SYSTEM_FIRE_UP                   (KEY_ID_MIN + 1677)
#define KEY_GUN_SYSTEM_RESET                     (KEY_ID_MIN + 1678)
#define KEY_GUN_SYSTEM_AXIS_FIRE                 (KEY_ID_MIN + 1679)

#define KEY_POSITION_FREEZE_USER                 (KEY_ID_MIN + 1680)
#define KEY_POSITION_FREEZE_ALL                  (KEY_ID_MIN + 1681)

#define KEY_GUN_SYSTEM_FIRE_BURST                 (KEY_ID_MIN + 1682)

#define KEY_DIS_TOGGLE_CONNECTION                (KEY_ID_MIN + 1690)
#define KEY_DIS_START_RESUME_ENTITIES            (KEY_ID_MIN + 1691)
#define KEY_DIS_STOP_FREEZE_ENTITIES             (KEY_ID_MIN + 1692)

#define KEY_TURB_ENG_PWR_MANAGE_SYSTEM_SWITCH_SET_ON   (KEY_ID_MIN + 1720)
#define KEY_TURB_ENG_PWR_MANAGE_SYSTEM_SWITCH_SET_OFF  (KEY_ID_MIN + 1721)
#define KEY_TURB_ENG_PWR_MANAGE_SYSTEM_SWITCH_TOGGLE   (KEY_ID_MIN + 1722)

//Tacan
#define KEY_TACAN1_RADIO_SWAP           (KEY_ID_MIN + 1731)
#define KEY_TACAN2_RADIO_SWAP           (KEY_ID_MIN + 1732)
#define KEY_TACAN1_STBY_CHANNEL_SET     (KEY_ID_MIN + 1733)
#define KEY_TACAN2_STBY_CHANNEL_SET     (KEY_ID_MIN + 1734)
#define KEY_TACAN1_CHANNEL_SET          (KEY_ID_MIN + 1735)
#define KEY_TACAN2_CHANNEL_SET          (KEY_ID_MIN + 1736)
#define KEY_TACAN1_CHANNEL_DEC          (KEY_ID_MIN + 1737)
#define KEY_TACAN2_CHANNEL_DEC          (KEY_ID_MIN + 1738)
#define KEY_TACAN1_CHANNEL_INC          (KEY_ID_MIN + 1739)
#define KEY_TACAN2_CHANNEL_INC          (KEY_ID_MIN + 1740)
#define KEY_TACAN1_XY_BAND_SET          (KEY_ID_MIN + 1741)
#define KEY_TACAN2_XY_BAND_SET          (KEY_ID_MIN + 1742)
#define KEY_TACAN1_XY_BAND_TOGGLE       (KEY_ID_MIN + 1743)
#define KEY_TACAN2_XY_BAND_TOGGLE       (KEY_ID_MIN + 1744)

#define KEY_RADIO_TACAN1_IDENT_DISABLE    (KEY_ID_MIN + 1745)
#define KEY_RADIO_TACAN2_IDENT_DISABLE    (KEY_ID_MIN + 1746)
#define KEY_RADIO_TACAN1_IDENT_ENABLE     (KEY_ID_MIN + 1747)
#define KEY_RADIO_TACAN2_IDENT_ENABLE     (KEY_ID_MIN + 1748)
#define KEY_RADIO_TACAN1_IDENT_TOGGLE     (KEY_ID_MIN + 1749)
#define KEY_RADIO_TACAN2_IDENT_TOGGLE     (KEY_ID_MIN + 1750)
#define KEY_RADIO_TACAN1_IDENT_SET        (KEY_ID_MIN + 1751)
#define KEY_RADIO_TACAN2_IDENT_SET        (KEY_ID_MIN + 1752)

//Panel Softkeys
#define KEY_PANEL_SOFT_KEY1             (KEY_ID_MIN + 1753)
#define KEY_PANEL_SOFT_KEY2             (KEY_ID_MIN + 1754)
#define KEY_PANEL_SOFT_KEY3             (KEY_ID_MIN + 1755)
#define KEY_PANEL_SOFT_KEY4             (KEY_ID_MIN + 1756)
#define KEY_PANEL_SOFT_KEY5             (KEY_ID_MIN + 1757)
#define KEY_PANEL_SOFT_KEY6             (KEY_ID_MIN + 1758)
#define KEY_PANEL_SOFT_KEY7             (KEY_ID_MIN + 1759)
#define KEY_PANEL_SOFT_KEY8             (KEY_ID_MIN + 1760)
#define KEY_PANEL_SOFT_KEY9             (KEY_ID_MIN + 1761)
#define KEY_HOTAS_SLEW_AXIS_X           (KEY_ID_MIN + 1762)
#define KEY_HOTAS_SLEW_AXIS_Y           (KEY_ID_MIN + 1763)
#define KEY_HOTAS_CASTLE_UP             (KEY_ID_MIN + 1764)
#define KEY_HOTAS_CASTLE_DOWN           (KEY_ID_MIN + 1765)
#define KEY_HOTAS_CASTLE_LEFT           (KEY_ID_MIN + 1766)
#define KEY_HOTAS_CASTLE_RIGHT          (KEY_ID_MIN + 1767)
#define KEY_HOTAS_HAT_UP                (KEY_ID_MIN + 1768)
#define KEY_HOTAS_HAT_DOWN              (KEY_ID_MIN + 1769)
#define KEY_HOTAS_HAT_LEFT              (KEY_ID_MIN + 1770)
#define KEY_HOTAS_HAT_RIGHT             (KEY_ID_MIN + 1771)
#define KEY_HOTAS_PICKLE                (KEY_ID_MIN + 1772)
#define KEY_HOTAS_TRIGGER               (KEY_ID_MIN + 1773)

#define KEY_HOTAS_KEY_A0                (KEY_ID_MIN + 1774)
#define KEY_HOTAS_KEY_A1                (KEY_ID_MIN + 1775)
#define KEY_HOTAS_KEY_A2                (KEY_ID_MIN + 1776)
#define KEY_HOTAS_KEY_A3                (KEY_ID_MIN + 1777)
#define KEY_HOTAS_KEY_A4                (KEY_ID_MIN + 1778)
#define KEY_HOTAS_KEY_A5                (KEY_ID_MIN + 1779)
#define KEY_HOTAS_KEY_A6                (KEY_ID_MIN + 1780)
#define KEY_HOTAS_KEY_A7                (KEY_ID_MIN + 1781)
#define KEY_HOTAS_KEY_A8                (KEY_ID_MIN + 1782)
#define KEY_HOTAS_KEY_A9                (KEY_ID_MIN + 1783)
#define KEY_HOTAS_KEY_B0                (KEY_ID_MIN + 1784)
#define KEY_HOTAS_KEY_B1                (KEY_ID_MIN + 1785)
#define KEY_HOTAS_KEY_B2                (KEY_ID_MIN + 1786)
#define KEY_HOTAS_KEY_B3                (KEY_ID_MIN + 1787)
#define KEY_HOTAS_KEY_B4                (KEY_ID_MIN + 1788)
#define KEY_HOTAS_KEY_B5                (KEY_ID_MIN + 1789)
#define KEY_HOTAS_KEY_B6                (KEY_ID_MIN + 1790)
#define KEY_HOTAS_KEY_B7                (KEY_ID_MIN + 1791)
#define KEY_HOTAS_KEY_B8                (KEY_ID_MIN + 1792)
#define KEY_HOTAS_KEY_B9                (KEY_ID_MIN + 1793)

#define KEY_WEAPON_SYSTEM_SELECT_BY_TYPE_INDEX_SET   (KEY_ID_MIN + 1802)

#define KEY_GENALT_BUS1_CONTACT_SET      (KEY_ID_MIN + 1810)
#define KEY_GENALT_BUS2_CONTACT_SET      (KEY_ID_MIN + 1811)
#define KEY_GENALT_BUS3_CONTACT_SET      (KEY_ID_MIN + 1812)
#define KEY_GENALT_BUS4_CONTACT_SET      (KEY_ID_MIN + 1813)
#define KEY_TOGGLE_GENALT_BUS1_CONTACT   (KEY_ID_MIN + 1814)
#define KEY_TOGGLE_GENALT_BUS2_CONTACT   (KEY_ID_MIN + 1815)
#define KEY_TOGGLE_GENALT_BUS3_CONTACT   (KEY_ID_MIN + 1816)
#define KEY_TOGGLE_GENALT_BUS4_CONTACT   (KEY_ID_MIN + 1817)

#define KEY_BATTERY_BUS_CONTACT_SET      (KEY_ID_MIN + 1818)
#define KEY_TOGGLE_BATTERY_BUS_CONTACT   (KEY_ID_MIN + 1819)

#define KEY_COM1_RADIO_HZ_SET              (KEY_ID_MIN + 1825)
#define KEY_COM2_RADIO_HZ_SET              (KEY_ID_MIN + 1826)
#define KEY_COM1_STBY_RADIO_HZ_SET         (KEY_ID_MIN + 1827)
#define KEY_COM2_STBY_RADIO_HZ_SET         (KEY_ID_MIN + 1828)

#define KEY_RADIO_TACAN_DME1_IDENT_SET        (KEY_ID_MIN + 1840)
#define KEY_RADIO_TACAN_DME2_IDENT_SET        (KEY_ID_MIN + 1841)
#define KEY_RADIO_TACAN_DME1_IDENT_TOGGLE     (KEY_ID_MIN + 1842)
#define KEY_RADIO_TACAN_DME2_IDENT_TOGGLE     (KEY_ID_MIN + 1843)
#define KEY_RADIO_TACAN_DME1_IDENT_ENABLE     (KEY_ID_MIN + 1844)
#define KEY_RADIO_TACAN_DME2_IDENT_ENABLE     (KEY_ID_MIN + 1845)
#define KEY_RADIO_TACAN_DME1_IDENT_DISABLE    (KEY_ID_MIN + 1846)
#define KEY_RADIO_TACAN_DME2_IDENT_DISABLE    (KEY_ID_MIN + 1847)

// Prepar3D Recorder
#define KEY_RECORDER_RECORD_START           (KEY_ID_MIN + 1860)

#define KEY_ELEVATOR_HYDRAULIC_BOOST_TOGGLE (KEY_ID_MIN + 1870)
#define KEY_ELEVATOR_HYDRAULIC_BOOST_SET    (KEY_ID_MIN + 1871)
#define KEY_ELEVATOR_HYDRAULIC_BOOST_ON     (KEY_ID_MIN + 1872)
#define KEY_ELEVATOR_HYDRAULIC_BOOST_OFF    (KEY_ID_MIN + 1873)
#define KEY_AILERON_HYDRAULIC_BOOST_TOGGLE  (KEY_ID_MIN + 1874)
#define KEY_AILERON_HYDRAULIC_BOOST_SET     (KEY_ID_MIN + 1875)
#define KEY_AILERON_HYDRAULIC_BOOST_ON      (KEY_ID_MIN + 1876)
#define KEY_AILERON_HYDRAULIC_BOOST_OFF     (KEY_ID_MIN + 1877)
#define KEY_RUDDER_HYDRAULIC_BOOST_TOGGLE   (KEY_ID_MIN + 1878)
#define KEY_RUDDER_HYDRAULIC_BOOST_SET      (KEY_ID_MIN + 1879)
#define KEY_RUDDER_HYDRAULIC_BOOST_ON       (KEY_ID_MIN + 1880)
#define KEY_RUDDER_HYDRAULIC_BOOST_OFF      (KEY_ID_MIN + 1881)

// Second set of generic keys to control the HOTAS
#define KEY_HOTAS_KEY_C0                    (KEY_ID_MIN + 1900)
#define KEY_HOTAS_KEY_C1                    (KEY_ID_MIN + 1901)
#define KEY_HOTAS_KEY_C2                    (KEY_ID_MIN + 1902)
#define KEY_HOTAS_KEY_C3                    (KEY_ID_MIN + 1903)
#define KEY_HOTAS_KEY_C4                    (KEY_ID_MIN + 1904)
#define KEY_HOTAS_KEY_C5                    (KEY_ID_MIN + 1905)
#define KEY_HOTAS_KEY_C6                    (KEY_ID_MIN + 1906)
#define KEY_HOTAS_KEY_C7                    (KEY_ID_MIN + 1907)
#define KEY_HOTAS_KEY_C8                    (KEY_ID_MIN + 1908)
#define KEY_HOTAS_KEY_C9                    (KEY_ID_MIN + 1909)
#define KEY_HOTAS_KEY_D0                    (KEY_ID_MIN + 1910)
#define KEY_HOTAS_KEY_D1                    (KEY_ID_MIN + 1911)
#define KEY_HOTAS_KEY_D2                    (KEY_ID_MIN + 1912)
#define KEY_HOTAS_KEY_D3                    (KEY_ID_MIN + 1913)
#define KEY_HOTAS_KEY_D4                    (KEY_ID_MIN + 1914)
#define KEY_HOTAS_KEY_D5                    (KEY_ID_MIN + 1915)
#define KEY_HOTAS_KEY_D6                    (KEY_ID_MIN + 1916)
#define KEY_HOTAS_KEY_D7                    (KEY_ID_MIN + 1917)
#define KEY_HOTAS_KEY_D8                    (KEY_ID_MIN + 1918)
#define KEY_HOTAS_KEY_D9                    (KEY_ID_MIN + 1919)
// set of generic axis
#define KEY_HOTAS_AXIS_A0                   (KEY_ID_MIN + 1920)
#define KEY_HOTAS_AXIS_A1                   (KEY_ID_MIN + 1921)
#define KEY_HOTAS_AXIS_A2                   (KEY_ID_MIN + 1922)
#define KEY_HOTAS_AXIS_A3                   (KEY_ID_MIN + 1923)
#define KEY_HOTAS_AXIS_A4                   (KEY_ID_MIN + 1924)
#define KEY_HOTAS_AXIS_A5                   (KEY_ID_MIN + 1925)
#define KEY_HOTAS_AXIS_A6                   (KEY_ID_MIN + 1926)
#define KEY_HOTAS_AXIS_A7                   (KEY_ID_MIN + 1927)
#define KEY_HOTAS_AXIS_A8                   (KEY_ID_MIN + 1928)
#define KEY_HOTAS_AXIS_A9                   (KEY_ID_MIN + 1929)

#define KEY_TURBINE_IGNITION_SWITCH_SET      (KEY_ID_MIN + 1940)
#define KEY_TURBINE_IGNITION_SWITCH_SET_ON   (KEY_ID_MIN + 1941)
#define KEY_TURBINE_IGNITION_SWITCH_SET_OFF  (KEY_ID_MIN + 1942)
#define KEY_TURBINE_IGNITION_SWITCH_SET_AUTO (KEY_ID_MIN + 1943)

#define KEY_ELECTRIC_GPU_SWITCH_TOGGLE      (KEY_ID_MIN + 1950)
#define KEY_ELECTRIC_GPU_SWITCH_SET         (KEY_ID_MIN + 1951)

#define KEY_RUDDER_TRIM_AID_SWITCH_TOGGLE   (KEY_ID_MIN + 1955)
#define KEY_RUDDER_TRIM_AID_SWITCH_SET      (KEY_ID_MIN + 1956)

#define KEY_ELEV_AILERONS_TRIM              (KEY_ID_MIN + 1957)
#define KEY_ELEV_RUDDER_TRIM                (KEY_ID_MIN + 1958)

#define KEY_LANDING_LIGHTS_ROTATE           (KEY_ID_MIN + 1959)

#define KEY_AVATAR_MODE_ATTACH_SET          (KEY_ID_MIN + 1960)
#define KEY_AVATAR_MODE_ATTACH_TOGGLE       (KEY_ID_MIN + 1961)

#define KEY_HMD_RECALIBRATE_ORIGIN                  (KEY_ID_MIN + 2400)
#define KEY_HMD_TOGGLE_STEREO                       (KEY_ID_MIN + 2401)
#define KEY_HMD_ROTATE_EYES_OUT                     (KEY_ID_MIN + 2402)
#define KEY_HMD_ROTATE_EYES_IN                      (KEY_ID_MIN + 2403)
#define KEY_HMD_INCREASE_HFOV                       (KEY_ID_MIN + 2404)
#define KEY_HMD_DECREASE_HFOV                       (KEY_ID_MIN + 2405)
#define KEY_HMD_SAVE_TRACKER_OFFSET                 (KEY_ID_MIN + 2406)

#define KEY_ADF1_PRIMARY_SET                        (KEY_ID_MIN + 2500)
#define KEY_ADF2_PRIMARY_SET                        (KEY_ID_MIN + 2501)
#define KEY_ADF1_STBY_SET                           (KEY_ID_MIN + 2502)
#define KEY_ADF2_STBY_SET                           (KEY_ID_MIN + 2503)

#define KEY_SD_SELECT_ALL_OBJECTS                   (KEY_ID_MIN + 2504)
...
#define KEY_AXIS_THROTTLE_REVERSER1_SET             (KEY_ID_MIN + 2511)
#define KEY_AXIS_THROTTLE_REVERSER2_SET             (KEY_ID_MIN + 2512)
#define KEY_AXIS_THROTTLE_REVERSER3_SET             (KEY_ID_MIN + 2513)
#define KEY_AXIS_THROTTLE_REVERSER4_SET             (KEY_ID_MIN + 2514)

#define KEY_HMD_MENU_BAR                            (KEY_ID_MIN + 2515)
#define KEY_HMD_GAZE_CLICK_DOWN                     (KEY_ID_MIN + 2516)
#define KEY_HMD_GAZE_CLICK_UP                       (KEY_ID_MIN + 2517)

#define KEY_CONTROLLABLE_CAMERA_AXIS_X              (KEY_ID_MIN + 2518)
#define KEY_CONTROLLABLE_CAMERA_AXIS_Y              (KEY_ID_MIN + 2519)
#define KEY_CONTROLLABLE_CAMERA_SENSOR_MODE         (KEY_ID_MIN + 2520)
#define KEY_CONTROLLABLE_CAMERA_TRACKING            (KEY_ID_MIN + 2521)
#define KEY_CONTROLLABLE_CAMERA_ZOOM_IN             (KEY_ID_MIN + 2522)
#define KEY_CONTROLLABLE_CAMERA_ZOOM_OUT            (KEY_ID_MIN + 2523)

#define KEY_HMD_GAZE_RIGHT_CLICK_DOWN               (KEY_ID_MIN + 2524)
#define KEY_HMD_GAZE_RIGHT_CLICK_UP                 (KEY_ID_MIN + 2525)
#define KEY_RELOAD_SHADERS                          (KEY_ID_MIN + 2526)
#define KEY_TOGGLE_FLASHLIGHT                       (KEY_ID_MIN + 2527)

#define KEY_COM1_8333HZ_MODE_TOGGLE                 (KEY_ID_MIN + 2528)
#define KEY_COM1_8333HZ_MODE_SET                    (KEY_ID_MIN + 2529)
#define KEY_COM2_8333HZ_MODE_TOGGLE                 (KEY_ID_MIN + 2530)
#define KEY_COM2_8333HZ_MODE_SET                    (KEY_ID_MIN + 2531)

#define KEY_TACAN1_OBS_SET                          (KEY_ID_MIN + 2532)
#define KEY_TACAN1_OBS_INC                          (KEY_ID_MIN + 2533)
#define KEY_TACAN1_OBS_DEC                          (KEY_ID_MIN + 2534)
#define KEY_TACAN1_OBS_FAST_INC                     (KEY_ID_MIN + 2535)
#define KEY_TACAN1_OBS_FAST_DEC                     (KEY_ID_MIN + 2536)
#define KEY_TACAN2_OBS_SET                          (KEY_ID_MIN + 2537)
#define KEY_TACAN2_OBS_INC                          (KEY_ID_MIN + 2538)
#define KEY_TACAN2_OBS_DEC                          (KEY_ID_MIN + 2539)
#define KEY_TACAN2_OBS_FAST_INC                     (KEY_ID_MIN + 2540)
#define KEY_TACAN2_OBS_FAST_DEC                     (KEY_ID_MIN + 2541)

#define KEY_AP_NAV_MODE_TACAN_TOGGLE                (KEY_ID_MIN + 2542)
#define KEY_AP_NAV_MODE_TACAN_SET                   (KEY_ID_MIN + 2543)

#define KEY_BEACON_LIGHTS_ON                        (KEY_ID_MIN + 2550)
#define KEY_BEACON_LIGHTS_OFF                       (KEY_ID_MIN + 2551)
#define KEY_BEACON_LIGHTS_SET                       (KEY_ID_MIN + 2552)

#define KEY_NAV_LIGHTS_ON                           (KEY_ID_MIN + 2553)
#define KEY_NAV_LIGHTS_OFF                          (KEY_ID_MIN + 2554)
#define KEY_NAV_LIGHTS_SET                          (KEY_ID_MIN + 2555)

#define KEY_TAXI_LIGHTS_ON                          (KEY_ID_MIN + 2556)
#define KEY_TAXI_LIGHTS_OFF                         (KEY_ID_MIN + 2557)
#define KEY_TAXI_LIGHTS_SET                         (KEY_ID_MIN + 2558)

#define KEY_BRAKE_LIGHTS_ON                         (KEY_ID_MIN + 2559)
#define KEY_BRAKE_LIGHTS_OFF                        (KEY_ID_MIN + 2560)
#define KEY_BRAKE_LIGHTS_SET                        (KEY_ID_MIN + 2561)

#define KEY_HEADLIGHT_LIGHTS_ON                     (KEY_ID_MIN + 2562)
#define KEY_HEADLIGHT_LIGHTS_OFF                    (KEY_ID_MIN + 2563)
#define KEY_HEADLIGHT_LIGHTS_SET                    (KEY_ID_MIN + 2564)

#define KEY_GENERAL_LIGHTS_ON                       (KEY_ID_MIN + 2565)
#define KEY_GENERAL_LIGHTS_OFF                      (KEY_ID_MIN + 2566)
#define KEY_GENERAL_LIGHTS_SET                      (KEY_ID_MIN + 2567)

#define KEY_LOGO_LIGHTS_ON                          (KEY_ID_MIN + 2568)
#define KEY_LOGO_LIGHTS_OFF                         (KEY_ID_MIN + 2569)
#define KEY_LOGO_LIGHTS_SET                         (KEY_ID_MIN + 2570)

#define KEY_RECOGNITION_LIGHTS_ON                   (KEY_ID_MIN + 2571)
#define KEY_RECOGNITION_LIGHTS_OFF                  (KEY_ID_MIN + 2572)
#define KEY_RECOGNITION_LIGHTS_SET                  (KEY_ID_MIN + 2573)

#define KEY_WING_LIGHTS_ON                          (KEY_ID_MIN + 2574)
#define KEY_WING_LIGHTS_OFF                         (KEY_ID_MIN + 2575)
#define KEY_WING_LIGHTS_SET                         (KEY_ID_MIN + 2576)

#define KEY_CABIN_LIGHTS_ON                         (KEY_ID_MIN + 2577)
#define KEY_CABIN_LIGHTS_OFF                        (KEY_ID_MIN + 2578)
#define KEY_CABIN_LIGHTS_SET                        (KEY_ID_MIN + 2579)

#define KEY_ALL_LIGHTS_ON                           (KEY_ID_MIN + 2580)
#define KEY_ALL_LIGHTS_OFF                          (KEY_ID_MIN + 2581)
#define KEY_ALL_LIGHTS_SET                          (KEY_ID_MIN + 2582)

#define KEY_HMD_GAZE_SCROLL_UP                      (KEY_ID_MIN + 2583)
#define KEY_HMD_GAZE_SCROLL_DOWN                    (KEY_ID_MIN + 2584)
...
// The following types are deprecated.  Kept for backwards compatibility.
typedef PCHAR       *PPCHAR; // DEPRECATED pointer to pointer to char
typedef CHAR        STRING, *PSTRING, **PPSTRING; // DEPRECATED generic string of unknown length
typedef CHAR        STRINGZ, *PSTRINGZ, **PPSTRINGZ; // DEPRECATED generic string of unknown length, zero term
typedef const CHAR  *PCSTRINGZ, **PPCSTRINGZ; // DEPRECATED generic string of unknown length, zero term
...
public:
    ...
    * @param        szParName   The parameter name.
    * @param        pszValue    The parameter's char* value.
    ...
    * @param        szParName   The parameter name.
    * @param        pdValue     The parameter's FLOAT64 value.
    * @return       True if parameter name and value found, false otherwise.
    **/
    ...
    * @param        szParName   The parameter name.
    * @param        pbValue     The parameter's bool value.
    * @return       True if parameter name and value found, false otherwise.
    **/
    ...
    * @return       True if szParName is found and other parameters are set, false otherwise.
    **/
    virtual bool SetParameterId(const char* szParName, SINT32 id, PARAMETER_TYPE type) const = 0;
};

/**
* The IGaugeCDrawableDrawParameters class gets the parameters passed into Prepar3D
* from the IGaugeCDrawableCreateParameters class.
*
* See the Custom_Nav_Draw sample for an example use case.
**/
...
public:
    ...
    * @param        id          The parameter id.
    * @param        pszValue    The parameter's FLOAT64 value.
    * @return       True if parameter id and value found, false otherwise.
    **/
    ...
    * @param        id          The parameter id.
    * @param        pszValue    The parameter's bool value.
    * @return       True if parameter id and value found, false otherwise.
    **/
    ...
    /**
    * Gets the scale of X.
    * @return       Value of scale X.
    **/
    virtual FLOAT64 GetScaleX() const = 0;

    /**
    * Gets the scale of Y.
    * @return       Value of scale Y.
    **/
    virtual FLOAT64 GetScaleY() const = 0;

    /**
    * Gets screen rectangle.
    * @return       Pointer to a rect relative to the flight sim window left top corner or NULL if undocked or virtual cockpit.
    **/
...
public:
    ...
    enum GAUGE_DRAWABLE_FLAGS {
        ...
        DRAWS_ALPHA = 0x8,          // wants to use alpha channel---------------------ignored if TAKES_DC is on
        NO_TRANSPARENCY = 0x10,     // image is solid rectangle
        MASK_TRANSPARENCY = 0x20,   // use alpha channel to mask image----------------ignored if TAKES_DC is on
    ...
    * @return       Return a set of flags. Valid flags are listed in GAUGE_DRAWABLE_FLAGS.
    * @remarks      The flags tell Prepar3D how to setup the custom gauge element.
    **/
    ...
    * @param        pParameters Passes the parameters defined in the xml file.
    * @param        size        Size of the image.
    * @param        hdc         Pass through the hdc if TAKES_DC is enabled.
    * @param        pImage      Pass through the image if TAKES_PIMAGE is enabled.
    * @return       If the image changed, return true for draw. False otherwise.
    **/
...
/**
* The IGaugeCCallback is an abstract base class that can be overridden. Implementors should
* override the function CreateGaugeCDrawable(SINT32 id, const IGaugeCDrawableCreateParameters* pParameters).
*
* See the Custom_Nav_Draw sample for an example use case.
**/
...
public:
    ...
    * @param        id          The property value's id.
    * @param        pValue      The property value's FLOAT64 value.
    * @return       True if id and value found, false otherwise.
    **/
    ...
    * @param        id          The property value's id.
    * @param        pszValue    The property value's LPCSTR value.
    * @return       True if id and value found, false otherwise.
    **/
    ...
    * @param        id          The property value's id.
    * @param        pszValue    The property value's LPCWSTR value.
    * @return       True if id and value found, false otherwise.
    **/
    ...
    * @param        id          The property value's id.
    * @param        value       The property value's FLOAT64 value.
    * @return       True if id found and value set, false otherwise.
    **/
    ...
    * @param        id          The property value's id.
    * @param        szValue     The property value's LPCSTR value.
    * @return       True if id found and value set, false otherwise.
    **/
    ...
    * @param        id          The property value's id.
    * @param        szValue     The property value's LPCWSTR value.
    * @return       True if id found and value set, false otherwise.
    **/
    ...
    * @param        id          The gauge drawable's id.
...
struct NetInPublic;     // include NetInOutPublic.h
struct NetOutPublic;    // include NetInOutPublic.h
...
public:
    ...
    **/
    ...
    /**
    * Query Interface.
    * @param        pszInterface     The Interface.
    **/
...
public:
    ...
    * @param        ContainerID      The containers id.
    **/
    ...
    * @param        pID              The id.
    * @return       True if keyword found and pID value set, false otherwise.
    **/
    ...
    * @return       True if id found and pKeyword value set, false otherwise.
    **/
    ...
    * @return       True if id found and pEnum value set, false otherwise.
    **/
    virtual bool  GetPropertyUnits(SINT32 id, ENUM* pEnum) = 0; // UNITS_UNKNOWN if no units, UNITS_STRING or UNITS_WSTRING if narrow or wide string
};
...
enum ELEMENT_TYPE_ENUM
{
    ...
    ELEMENT_TYPE_SPRITE,
    ELEMENT_TYPE_DXGAUGE,    // deprecated
    ELEMENT_TYPE_COUNT,
};
...
typedef struct  PANELS
{
    ...
    void        (FSAPI *register_var_by_name) (PVOID var, VAR_TYPE var_type, LPCSTR name);
    void        (FSAPI *initialize_var) (PMODULE_VAR module_var);
    void        (FSAPI *initialize_var_by_name) (PMODULE_VAR module_var, LPCSTR name);
    void        (FSAPI *lookup_var) (PMODULE_VAR module_var);
    void        (FSAPI *unregister_var_by_name) (LPCSTR name);
    ...
    ID          (FSAPI *check_named_variable) (LPCSTR name);
    ID          (FSAPI *register_named_variable) (LPCSTR name);
    ...
    LPCSTR      (FSAPI *get_name_of_named_variable) (ID id);
    void        (FSAPI *reserved29) (void);
    LPCWSTR     (FSAPI *panel_resource_string_get) (ID32 id);
    ...
    void        (FSAPI *set_gauge_flags) (LPCSTR name, FLAGS32 newflags);        // newlags is GAUGE_FLAG_NORMAL, GAUGE_FLAG_HIDDEN...
    FLAGS32     (FSAPI *get_gauge_flags) (LPCSTR name);
    BOOL        (FSAPI *gauge_calculator_code_precompile) (LPCSTR* pCompiled, UINT32* pCompiledSize, LPCSTR source);
    BOOL        (FSAPI *execute_calculator_code) (LPCSTR code, FLOAT64* fvalue, SINT32* ivalue, LPCSTR* svalue);
    BOOL        (FSAPI *format_calculator_string) (LPSTR result, UINT32 resultsize, LPCSTR format);
    ...
    void        (FSAPI *reserved36) (void);
    void        (FSAPI *set_named_variable_value_sync) (ID id, FLOAT64 value);
    void        (FSAPI *set_named_variable_sync_enabled) (ID id, bool bSync);
    LPCWSTR     (FSAPI *get_event_description) (ID32 event_id);
    LPCWSTR     (FSAPI *get_event_token_string) (ID32 event_id);
    HRESULT     (FSAPI *query_pdk)(REFIID riid, void** ppPdk);
    UINT32      (FSAPI *get_event_count) (void);
    ID32        (FSAPI *get_event_id_by_index) (UINT32 uIndex);
