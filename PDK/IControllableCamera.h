...
#include <atlcomcli.h>
#include <Unknwn.h>
#include "Legacy/IControllableCamera.Legacy.h"
...
public:
    ...
    */
    ...
    // Static Variables
    //----------------------------------------------------------------------------
    static const char CONTROLLABLE_CAMERA_CALLBACK_NAME[] = ("P3DControllableCamera");
    static const char CONTROLLABLE_CAMERA_INTERFACE_NAME[] = ("IControllableCamera");

    /**
        Interface for ControllableCamera PDK service
    */
    class IControllableCameraV450 : public IControllableCameraV400
    {
    public:
        /**
        ...
        */
        virtual void TrackWeaponTarget() abstract;
        /**
            Stop camera from tracking the current weapon system target (fire control system)
        */
        virtual void UntrackWeaponTarget() abstract;
    };

    //{91C94FB3-3052-4E3D-A58E-A4E5EAAE1C55}
    interface __declspec(uuid("{91C94FB3-3052-4E3D-A58E-A4E5EAAE1C55}")) IControllableCameraV450;
    extern __declspec(selectany) REFIID  IID_IControllableCameraV450 = __uuidof(IControllableCameraV450);
    extern __declspec(selectany) REFGUID SID_ControllableCamera = __uuidof(IControllableCameraV400);
}